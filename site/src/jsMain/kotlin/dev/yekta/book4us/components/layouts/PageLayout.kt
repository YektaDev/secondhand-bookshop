package dev.yekta.book4us.components.layouts
...
import dev.yekta.book4us.components.sections.Footer
import dev.yekta.book4us.components.sections.NavHeader
...
fun PageLayout(title: String, content: @Composable ColumnScope.() -> Unit) {
    LaunchedEffect(title) { document.title = "Book4Us - $title" }
    Box(
        Modifier
            .fillMaxWidth()
